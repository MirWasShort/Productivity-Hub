...
@override@JsonKey(fromJson: taskStatusFromJson, toJson: _statusToJson) final  TaskStatus status;
@override@JsonKey(fromJson: taskPriorityFromJson, toJson: _priorityToJson) final  TaskPriority priority;
